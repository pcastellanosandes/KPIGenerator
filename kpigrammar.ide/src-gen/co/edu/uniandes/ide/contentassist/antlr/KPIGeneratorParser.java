	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTaskAccess().getAlternatives_10(), "rule__Task__Alternatives_10");
					...
					put(grammarAccess.getTaskAccess().getStatusNameAssignment_22(), "rule__Task__StatusNameAssignment_22");
					put(grammarAccess.getTaskAccess().getStatusTextAssignment_24(), "rule__Task__StatusTextAssignment_24");
