 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.kPIGenerator.impl.StatusImpl#getStatusName <em>Status Name</em>}</li>
 *   <li>{@link co.edu.uniandes.kPIGenerator.impl.StatusImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatusImpl extends MinimalEObjectImpl.Container implements Status
{
  ...
  {
    return KPIGeneratorPackage.Literals.STATUS;
  }
  ...
  public void setStatusName(String newStatusName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KPIGeneratorPackage.STATUS__STATUS_NAME, oldStatusName, statusName));
  }
  ...
  public void setText(String newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KPIGeneratorPackage.STATUS__TEXT, oldText, text));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KPIGeneratorPackage.STATUS__STATUS_NAME:
        return getStatusName();
      case KPIGeneratorPackage.STATUS__TEXT:
        return getText();
    }
