...
public class InternalKPIGeneratorLexer extends Lexer {
    ...
    public final void mRULE_SEMICOLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1961:16: ( ';' )
            // InternalKPIGenerator.g:1961:18: ';'
            {
            match(';'); 
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1963:14: ( ( '\\n' | EOF ) )
            // InternalKPIGenerator.g:1963:16: ( '\\n' | EOF )
            {
            // InternalKPIGenerator.g:1963:16: ( '\\n' | EOF )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalKPIGenerator.g:1963:17: '\\n'
                    {
                    match('\n'); 
                    ...
                    break;
                case 2 :
                    // InternalKPIGenerator.g:1963:22: EOF
                    {
                    match(EOF); 
    ...
    public final void mRULE_CADENA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1965:13: ( ( ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )* )+ )
            // InternalKPIGenerator.g:1965:15: ( ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )* )+
            {
            // InternalKPIGenerator.g:1965:15: ( ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )* )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalKPIGenerator.g:1965:16: ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )*
            	    {
            	    // InternalKPIGenerator.g:1965:16: ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+
            	    int cnt2=0;
            	    loop2:
            	    do {
            	        int alt2=2;
            	    ...
            	    // InternalKPIGenerator.g:1965:143: ( '0' .. '9' )*
            	    loop3:
            	    do {
            	        int alt3=2;
            	        ...
            	        switch (alt3) {
            	    	case 1 :
            	    	    // InternalKPIGenerator.g:1965:144: '0' .. '9'
            	    	    {
            	    	    matchRange('0','9'); 
    ...
    public final void mRULE_DATEHOUR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1967:15: ( '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' ' ' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ' ' ( 'AM' | 'PM' ) )
            // InternalKPIGenerator.g:1967:17: '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' ' ' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ' ' ( 'AM' | 'PM' )
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            match('/'); 
            ...
            matchRange('0','9'); 
            match(' '); 
            // InternalKPIGenerator.g:1967:145: ( 'AM' | 'PM' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalKPIGenerator.g:1967:146: 'AM'
                    {
                    match("AM"); 
                    ...
                    break;
                case 2 :
                    // InternalKPIGenerator.g:1967:151: 'PM'
                    {
                    match("PM"); 
    ...
    public final void mRULE_DATE() throws RecognitionException {
        try {
            int _type = RULE_DATE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1969:11: ( '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalKPIGenerator.g:1969:13: '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            match('/'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1971:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKPIGenerator.g:1971:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKPIGenerator.g:1971:11: ( '^' )?
            int alt6=2;
            ...
            // InternalKPIGenerator.g:1971:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1973:10: ( ( '0' .. '9' )+ )
            // InternalKPIGenerator.g:1973:12: ( '0' .. '9' )+
            {
            // InternalKPIGenerator.g:1973:12: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalKPIGenerator.g:1973:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1975:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalKPIGenerator.g:1975:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalKPIGenerator.g:1975:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalKPIGenerator.g:1975:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalKPIGenerator.g:1975:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // InternalKPIGenerator.g:1975:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalKPIGenerator.g:1975:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalKPIGenerator.g:1975:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalKPIGenerator.g:1975:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                        ...
                        switch (alt10) {
                    	case 1 :
                    	    // InternalKPIGenerator.g:1975:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalKPIGenerator.g:1975:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1977:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalKPIGenerator.g:1977:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalKPIGenerator.g:1977:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalKPIGenerator.g:1977:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1979:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKPIGenerator.g:1979:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKPIGenerator.g:1979:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop13:
            do {
                int alt13=2;
            ...
            // InternalKPIGenerator.g:1979:40: ( ( '\\r' )? '\\n' )?
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalKPIGenerator.g:1979:41: ( '\\r' )? '\\n'
                    {
                    // InternalKPIGenerator.g:1979:41: ( '\\r' )?
                    int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1981:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKPIGenerator.g:1981:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKPIGenerator.g:1981:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:1983:16: ( . )
            // InternalKPIGenerator.g:1983:18: .
            {
            matchAny(); 
