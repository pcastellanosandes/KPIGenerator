...
public class InternalKPIGeneratorLexer extends Lexer {
    ...
    public final void mRULE_CADENA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2433:13: ( ( ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )* )+ )
            // InternalKPIGenerator.g:2433:15: ( ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )* )+
            {
            // InternalKPIGenerator.g:2433:15: ( ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )* )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalKPIGenerator.g:2433:16: ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+ ( '0' .. '9' )*
            	    {
            	    // InternalKPIGenerator.g:2433:16: ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C1' | '\\u00E1' | '\\u00C9' | '\\u00E9' | '\\u00CD' | '\\u00ED' | '\\u00D3' | '\\u00F3' | '\\u00DA' | '\\u00FA' | '-' | ' ' | '|' | '.' )+
            	    int cnt1=0;
            	    loop1:
            	    do {
            	        int alt1=2;
            	    ...
            	    // InternalKPIGenerator.g:2433:143: ( '0' .. '9' )*
            	    loop2:
            	    do {
            	        int alt2=2;
            	        ...
            	        switch (alt2) {
            	    	case 1 :
            	    	    // InternalKPIGenerator.g:2433:144: '0' .. '9'
            	    	    {
            	    	    matchRange('0','9'); 
    ...
    public final void mRULE_DATE() throws RecognitionException {
        try {
            int _type = RULE_DATE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2435:11: ( '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalKPIGenerator.g:2435:13: '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            match('/'); 
    ...
    public final void mRULE_DATEHOUR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2437:15: ( '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' ' ' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ( ' AM' | ' PM' ) )
            // InternalKPIGenerator.g:2437:17: '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' ' ' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ( ' AM' | ' PM' )
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            match('/'); 
            ...
            matchRange('0','9'); 
            matchRange('0','9'); 
            // InternalKPIGenerator.g:2437:141: ( ' AM' | ' PM' )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalKPIGenerator.g:2437:142: ' AM'
                    {
                    match(" AM"); 
                    ...
                    break;
                case 2 :
                    // InternalKPIGenerator.g:2437:148: ' PM'
                    {
                    match(" PM"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2439:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKPIGenerator.g:2439:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKPIGenerator.g:2439:11: ( '^' )?
            int alt5=2;
            ...
            // InternalKPIGenerator.g:2439:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2441:10: ( ( '0' .. '9' )+ )
            // InternalKPIGenerator.g:2441:12: ( '0' .. '9' )+
            {
            // InternalKPIGenerator.g:2441:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalKPIGenerator.g:2441:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2443:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalKPIGenerator.g:2443:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalKPIGenerator.g:2443:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalKPIGenerator.g:2443:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalKPIGenerator.g:2443:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalKPIGenerator.g:2443:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalKPIGenerator.g:2443:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalKPIGenerator.g:2443:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalKPIGenerator.g:2443:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // InternalKPIGenerator.g:2443:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalKPIGenerator.g:2443:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2445:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalKPIGenerator.g:2445:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalKPIGenerator.g:2445:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalKPIGenerator.g:2445:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2447:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKPIGenerator.g:2447:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKPIGenerator.g:2447:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
            ...
            // InternalKPIGenerator.g:2447:40: ( ( '\\r' )? '\\n' )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalKPIGenerator.g:2447:41: ( '\\r' )? '\\n'
                    {
                    // InternalKPIGenerator.g:2447:41: ( '\\r' )?
                    int alt13=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2449:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKPIGenerator.g:2449:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKPIGenerator.g:2449:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKPIGenerator.g:2451:16: ( . )
            // InternalKPIGenerator.g:2451:18: .
            {
            matchAny(); 
    ...
    static final String DFA16_eotS =
        "\1\uffff\1\21\1\uffff\1\30\1\21\1\33\1\35\1\uffff\1\34\1\43\1\21\1\34\1\uffff\2\21\5\uffff\1\52\12\uffff\2\34\1\uffff\1\43\1\uffff\1\34\4\uffff\1\25\45\uffff\1\121\2\uffff";
    static final String DFA16_eofS =
        "\122\uffff";
    static final String DFA16_minS =
        "\2\0\1\uffff\1\175\2\42\1\40\1\uffff\2\60\1\101\1\11\1\uffff\1\0\1\52\4\uffff\2\0\4\uffff\1\151\1\141\4\uffff\2\60\1\uffff\1\57\1\uffff\1\11\4\uffff\1\143\13\uffff\1\141\1\60\1\150\1\141\1\uffff\1\145\2\uffff\1\157\2\uffff\1\60\11\uffff\1\57\4\60\1\40\2\uffff";
    static final String DFA16_maxS =
        "\2\uffff\1\uffff\1\175\2\42\1\u00fa\1\uffff\1\172\1\71\1\172\1\40\1\uffff\1\uffff\1\57\4\uffff\2\uffff\4\uffff\2\164\4\uffff\2\172\1\uffff\1\57\1\uffff\1\40\4\uffff\1\165\13\uffff\1\151\1\71\1\162\1\151\1\uffff\1\164\2\uffff\1\162\2\uffff\1\71\11\uffff\1\57\4\71\1\40\2\uffff";
    static final String DFA16_acceptS =
        "\2\uffff\1\2\4\uffff\1\35\4\uffff\1\44\2\uffff\1\41\1\51\1\52\1\1\2\uffff\1\46\1\2\1\6\1\3\2\uffff\1\7\1\41\1\15\1\35\2\uffff\1\44\1\uffff\1\45\1\uffff\1\51\1\47\1\50\1\1\1\uffff\1\40\1\4\1\11\1\36\1\12\1\16\1\23\1\24\1\25\1\31\1\32\4\uffff\1\13\1\uffff\1\20\1\22\1\uffff\1\33\1\34\1\uffff\1\5\1\21\1\10\1\30\1\37\1\14\1\17\1\26\1\27\6\uffff\1\43\1\42";
    static final String DFA16_specialS =
        "\1\1\1\3\13\uffff\1\4\5\uffff\1\0\1\2\75\uffff}>";
    static final String[] DFA16_transitionS = {
            "\11\21\2\20\2\21\1\20\22\21\1\13\1\21\1\1\4\21\1\15\4\21\1\5\1\17\1\6\1\16\12\11\7\21\32\10\1\2\1\21\1\3\1\12\1\14\1\21\32\10\1\4\1\17\1\7\103\21\1\17\7\21\1\17\3\21\1\17\5\21\1\17\6\21\1\17\6\21\1\17\7\21\1\17\3\21\1\17\5\21\1\17\6\21\1\17\uff05\21",
            "\42\25\1\22\11\25\1\23\120\25\1\24\uff82\25",
            "",
            "\1\27",
            "\1\31",
            "\1\32",
            "\1\34\14\uffff\2\34\1\uffff\12\34\7\uffff\32\34\6\uffff\32\34\1\uffff\1\34\104\uffff\1\34\7\uffff\1\34\3\uffff\1\34\5\uffff\1\34\6\uffff\1\34\6\uffff\1\34\7\uffff\1\34\3\uffff\1\34\5\uffff\1\34\6\uffff\1\34",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( ((LA16_19>='\u0000' && LA16_19<='!')||(LA16_19>='#' && LA16_19<='\uFFFF')) ) {s = 21;}
                    ...
                    case 3 : 
                        ...
                        else if ( ((LA16_1>='\u0000' && LA16_1<='!')||(LA16_1>='#' && LA16_1<='+')||(LA16_1>='-' && LA16_1<='|')||(LA16_1>='~' && LA16_1<='\uFFFF')) ) {s = 21;}
