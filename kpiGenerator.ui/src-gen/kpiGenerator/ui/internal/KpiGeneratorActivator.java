 ...
 */
package kpiGenerator.ui.internal;
 ...
 * introduced subclass. 
 */
public class KpiGeneratorActivator extends AbstractUIPlugin {

	public static final String CO_EDU_UNIANDES_KPIGENERATOR = "co.edu.uniandes.KPIGenerator";
	
	private static final Logger logger = Logger.getLogger(KpiGeneratorActivator.class);
	
	private static KpiGeneratorActivator INSTANCE;
	...
	public static KpiGeneratorActivator getInstance() {
		return INSTANCE;
	}
